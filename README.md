...
![Execução real da fixture sintética: S02 ausente, duas de três lojas confirmadas e fechamento bloqueado](docs/images/editorial-20260922/coverage-blocked.png)

Na demonstração local, o remetente omite S02, mas o calendário aprovado pelo operador ainda espera três lojas. O lote é bloqueado e os **R$ 64,00 anteriores permanecem publicados**. A imagem mostra a decisão; as leituras Delta e as asserções do [caso executado](docs/demo.md#demonstração-editorial-executada) verificam a preservação dos dados. [Imagem em tamanho completo](docs/images/editorial-20260922/coverage-blocked.png).
