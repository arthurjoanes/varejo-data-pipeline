...
Fontes desta seção, conferidas em **22/09/2026**: [pipeline.py](../src/retail_pipeline/pipeline.py) · [publication.py](../src/retail_pipeline/publication.py) · [compose.yaml](../compose.yaml).

## Runtime e recursos

Python 3.11.16, OpenJDK 17.0.20+8 (Alpine 17.0.20_p8-r0), PySpark 4.2.0 e Delta Lake 4.4.0 (Scala 2.13, artefato delta-spark_4.2_2.13). A combinação upstream consta das [notas oficiais Delta 4.4.0](https://github.com/delta-io/delta/releases/tag/v4.4.0), consultadas em **22/09/2026**. Essa fonte não certifica os rebuilds locais. Versões, hashes das substituições JVM e componentes opcionais removidos estão nos locks e em [atualização do runtime](runtime-upgrade.md). Este é o runtime do batch local com catálogo em memória, sem Hive/Thrift, Derby ou REPL remoto.
...
Fontes desta seção, conferidas em **22/09/2026**: [pyproject.toml](../pyproject.toml) · [Dockerfile](../Dockerfile) · [compose.yaml](../compose.yaml) · [spark.py](../src/retail_pipeline/spark.py).
...
Fontes desta seção, conferidas em **22/09/2026**: [retail_pipeline/contracts.py](../src/retail_pipeline/contracts.py) · [batch_contracts.py](../src/retail_pipeline/batch_contracts.py).
...
- [Delta Lake 4.4.0: release oficial](https://github.com/delta-io/delta/releases/tag/v4.4.0), consultada em **22/09/2026**. A matriz geral de releases não foi usada para inferir suporte a Spark 4.2.
- [Spark 4.2.0: runtime](https://spark.apache.org/docs/4.2.0/), consultado em **22/09/2026**.
- [Spark 4.2.0: Parquet e calendários](https://spark.apache.org/docs/4.2.0/sql-data-sources-parquet.html#configuration), consultado em **22/09/2026**.
...
Fontes desta seção, conferidas em **22/09/2026**: [prove_state.py](../scripts/prove_state.py) · [restore.json](evidence/state-proof/restore.json).
