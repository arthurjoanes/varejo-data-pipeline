...
A primeira tentativa usou uma imagem histórica; o scan posterior não é atribuído a ela. Restore e medição usam `sha256:3cc3b95c1985397f1a3601a1c66531180ba0b8ef8738e5901dd400e805c719f3`, com código atual montado somente para leitura. Spark 4.2.0, Delta 4.4.0 e 48 JARs do lock foram conferidos. O restore registrou 282 fontes: depois dele, apenas `.gitattributes` mudou para preservar LF nas evidências públicas; 281 fontes continuaram idênticas. Capturas e documentação posteriores não são apresentadas como parte do runtime executado.
