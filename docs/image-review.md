...
Os embeds do README e dos documentos usam somente um recorte focalizado de **644 × 318 px**, capturado diretamente do painel de cobertura pelo navegador. Os prints completos permanecem como links, preservando o contexto e os bytes das provas. O recorte usa o snapshot histórico de entrega ausente; não substitui a prova editorial separada de calendário/remetente.
